...
export const BUILTIN_MODEL_HIGH = 'gemini-3.1-flash-lite-preview';
export const BUILTIN_MODEL_MEDIUM = 'gemini-3.1-flash-lite-preview';
export const BUILTIN_MODEL_LOW = 'gemini-3.1-flash-lite-preview';
