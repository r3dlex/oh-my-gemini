...
## Purpose
Prompt sanitization and keyword-based execution-mode routing helpers.

## Key Files

| File | Description |
|------|-------------|
| `index.ts` | Implementation for the `keyword-detector` hook module. |
...
### Internal
- `src/lib/mode-names.ts` provides mode constants consumed here.
