...
## Purpose
Learned-skill persistence helpers that store reusable patterns from successful completions.

## Key Files

| File | Description |
|------|-------------|
| `index.ts` | Implementation for the `learner` hook module. |
...
### Internal
- Uses `src/lib/atomic-write.ts`, `src/lib/worktree-paths.ts`, and team result types.
