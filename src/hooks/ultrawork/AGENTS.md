...
## Purpose
Hook adapter that activates or routes Ultrawork mode from prompt keywords.

## Key Files

| File | Description |
|------|-------------|
| `index.ts` | Implementation for the `ultrawork` hook module. |
...
### Internal
- `src/modes/ultrawork.ts` provides the execution flow used by this hook.
