...
## Purpose
Bundled runtime `configure-notifications` skill asset used by OMG itself. Configure notification delivery for Slack, Discord, or Telegram.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Bundled runtime skill prompt and metadata for `configure-notifications`. |
