...
## Purpose
Bundled runtime `status` skill asset used by OMG itself. Summarize current progress, state, blockers, and next steps.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Bundled runtime skill prompt and metadata for `status`. |
