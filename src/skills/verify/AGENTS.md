...
## Purpose
Bundled runtime `verify` skill asset used by OMG itself. Validate completion evidence against acceptance criteria and report pass/fail.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Bundled runtime skill prompt and metadata for `verify`. |
