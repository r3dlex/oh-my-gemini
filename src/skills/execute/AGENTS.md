...
## Purpose
Bundled runtime `execute` skill asset used by OMG itself. Execute a concrete implementation task with concise progress and validation.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Bundled runtime skill prompt and metadata for `execute`. |
