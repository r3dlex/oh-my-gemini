...
const TASK_AUDIT_REASON_CODES = {
  CLAIM_ACCEPTED: 'OMP_CP_TASK_CLAIM_ACCEPTED',
  TRANSITION_COMPLETED: 'OMP_CP_TASK_TRANSITION_COMPLETED',
  TRANSITION_FAILED: 'OMP_CP_TASK_TRANSITION_FAILED',
  TRANSITION_CANCELLED: 'OMP_CP_TASK_TRANSITION_CANCELLED',
  TRANSITION_CANCELED: 'OMP_CP_TASK_TRANSITION_CANCELED',
  TRANSITION_BLOCKED: 'OMP_CP_TASK_TRANSITION_BLOCKED',
  TRANSITION_PENDING: 'OMP_CP_TASK_TRANSITION_PENDING',
  TRANSITION_IN_PROGRESS: 'OMP_CP_TASK_TRANSITION_IN_PROGRESS',
  TRANSITION_UNKNOWN: 'OMP_CP_TASK_TRANSITION_UNKNOWN',
  RELEASE_PENDING: 'OMP_CP_TASK_RELEASE_PENDING',
  RELEASE_BLOCKED: 'OMP_CP_TASK_RELEASE_BLOCKED',
  RELEASE_UNKNOWN: 'OMP_CP_TASK_RELEASE_UNKNOWN',
} as const;
