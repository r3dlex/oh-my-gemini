...
## Purpose
Defines the packaged `debug` extension skill. Reproduce or inspect a failure, isolate root cause, and validate a fix.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `debug` skill. |
