...
## Purpose
Defines the packaged `execute` extension skill. Execute a concrete implementation task with concise progress updates and validation evidence.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `execute` skill. |
