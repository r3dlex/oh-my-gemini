...
## Purpose
Defines the packaged `learn` extension skill. Extract a reusable lesson, checklist, or future skill idea from the current work.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `learn` skill. |
