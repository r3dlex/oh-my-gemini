...
## Purpose
Defines the packaged `team` extension skill. Orchestrate parallel tmux workers for a multi-agent team task.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `team` skill. |
