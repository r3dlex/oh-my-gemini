...
## Purpose
Defines the packaged `autopilot` extension skill. Autonomously drive a feature from clarified objective through implementation and verification.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `autopilot` skill. |
