...
## Purpose
Defines the packaged `cancel` extension skill. Safely stop active work, note what was interrupted, and preserve resumable context.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `cancel` skill. |
