...
## Purpose
Defines the packaged `deep-interview` extension skill. Run a structured Socratic interview to turn ambiguity into an implementation-ready brief.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `deep-interview` skill. |
