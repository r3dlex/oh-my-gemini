...
## Purpose
Defines the packaged `configure-notifications` extension skill. Configure notification delivery for Slack, Discord, or Telegram.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `configure-notifications` skill. |
