...
## Purpose
Defines the packaged `ask` extension skill. Run a focused Gemini advisor prompt and save the result as a reusable artifact.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `ask` skill. |
