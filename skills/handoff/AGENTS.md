...
## Purpose
Defines the packaged `handoff` extension skill. Produce a structured handoff document summarizing completed work and next steps.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `handoff` skill. |
