...
## Purpose
Defines the packaged `help` extension skill. Explain the relevant oh-my-gemini commands, skills, and workflow choices.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `help` skill. |
