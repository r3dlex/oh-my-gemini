...
## Purpose
Defines the packaged `verify` extension skill. Verify that acceptance criteria are met and work is complete.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `verify` skill. |
