...
## Purpose
Defines the packaged `review` extension skill. Perform a structured code review of recent changes or a specific scope.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `review` skill. |
