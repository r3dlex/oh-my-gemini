...
## Purpose
Defines the packaged `hud-setup` extension skill. Guide the user through enabling and tuning the oh-my-gemini HUD surface.

## Key Files

| File | Description |
|------|-------------|
| `SKILL.md` | Workflow definition, frontmatter metadata, and usage examples for the `hud-setup` skill. |
