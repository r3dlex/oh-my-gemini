...
interface OmgRoutingConfig {
  ...
  agentOverrides: Record<string, OmgRoutingOverride>;  // Per-agent overrides
...
interface OmgExternalModelsConfig {
  defaults: {
